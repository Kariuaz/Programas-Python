...
# El sistema debe ser capaz de registrar múltiples ventas, calcular los subtotales por tipo de copia y el total general. 
# Además, deberá clasificar el desempeño de las ventas del día con un mensaje descriptivo.


print('\033[H\033[J')
print("-" * 40)
print("Papelería la Malena, SA. de CV.")
print("programa para las ventas de fotocopias.")
print("-" * 40)
